...
local unholyStyle = false  -- Ratings and numbers will be under the notes (Swapped for downscroll) !WILL FORCE TO HUD AND DISABLE onPlayerCombo! 
local directNums = true   -- For unholyStyle | Combo numbers appear under ratings 

local showComboThng = false           -- Show that "unused" combo thing
...
local defaultPosRating = {nil, nil}    -- Positions it'll use for ratings when not on player combo | HUD 'n Other cam | default numbers: 450, 280
local defaultPosNum = {nil, nil}                                                                                    --| default numbers: 450, 365

local defaultPosRateGame = {550, 280}  -- Position for game cam | Defaults to my preset if untouched 
local defaultPosNumGame = {550, 400}
