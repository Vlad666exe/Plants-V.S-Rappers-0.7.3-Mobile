...
local beatsBefore = 12       -- How many beats before the first note will the time skip to   > (Default: 2)
local keybind = ''      -- What keybind will trigger the skip, leave blank for none     > (Default: 'back')
local keyboard = 'SPACE'         -- What keyboard key will trigger the skip, blank for none      > (Default: '')
